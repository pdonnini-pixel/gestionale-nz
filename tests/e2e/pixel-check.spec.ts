 ...
 */
const PAGES = ['/', '/scadenzario', '/fatturazione', '/banche', '/fornitori', '/report-sincronizzazioni', '/dipendenti', '/dipendenti?view=ferie', '/produttivita', '/incassi-giornalieri', '/chiusura-cassa', '/liquidazione-iva', '/fabbisogno', '/outlet/operativi', '/confronto-outlet', '/margini', '/margini-categoria', '/budget', '/cash-flow', '/scenario'] // '/' = dashboard; rotte chiave del ciclo passivo + banche + report sync + personale (organico granitico e scheda ferie, che carica pdfjs) + specchietto incassi (admin + cassiera) + simulazione fabbisogno + pagine outlet/analitiche (devono reggere un outlet in apertura senza ricavi)
