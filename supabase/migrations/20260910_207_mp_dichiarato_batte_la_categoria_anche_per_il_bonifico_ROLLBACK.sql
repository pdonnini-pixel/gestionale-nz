-- ROLLBACK 20260910_207 — rimette la versione della 201, dove la categoria poteva ancora
-- portare a carta una fattura che dichiara bonifico. Da usare solo per tornare esattamente
-- allo stato precedente. I dati corretti dalla 208 hanno il loro rollback dedicato, e va
-- eseguito PRIMA di questo, altrimenti il trigger rimette la carta sulle righe ripristinate.
