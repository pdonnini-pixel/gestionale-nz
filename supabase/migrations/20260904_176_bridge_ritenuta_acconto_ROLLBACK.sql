-- =============================================================================
-- ROLLBACK 176 — ripristina le due funzioni come erano prima del 04/09/2026
-- (bridge SDI passivo che ignora la ritenuta d'acconto, match notula sul solo lordo).
-- Le scadenze gia' generate NON vengono toccate: si torna solo al comportamento
-- precedente per i nuovi INSERT.
-- =============================================================================
