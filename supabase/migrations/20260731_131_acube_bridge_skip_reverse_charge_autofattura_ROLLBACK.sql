-- ROLLBACK 20260731_131 — ripristina il bridge SENZA il guard reverse charge.
-- ATTENZIONE: dopo il rollback il bridge tornera' a creare payable anche dai
-- documenti TD16/TD17/TD18/TD19 (autofatture/integrazioni), rigenerando le
-- "fatture fantasma". Usare solo per emergenza.
