-- ROLLBACK 20260806_143_v_payables_operative_payment_reality.sql
--
-- Ripristina la definizione della vista precedente (stato live: colonne fino a
-- is_auto_debit, last_action_by dal solo user_profiles, nessun campo "realtà
-- pagamento"). Applicare su NZ + Made + Zago se serve tornare indietro.
