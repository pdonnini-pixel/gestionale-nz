-- =====================================================================
-- ROLLBACK della 228 — rimozione della ricostruzione di maggio 2026
-- ---------------------------------------------------------------------
...
-- giornate di maggio 2026 create dalla ricostruzione, riconoscibili da
...
--  WHERE c.closing_date BETWEEN '2026-05-01' AND '2026-05-31';
...
WITH ric AS (
  SELECT id FROM public.outlet_daily_closings
   WHERE closing_date BETWEEN '2026-05-01' AND '2026-05-31'
...
-- Come per luglio e giugno, le righe di daily_revenue di maggio ESISTEVANO GIA'
