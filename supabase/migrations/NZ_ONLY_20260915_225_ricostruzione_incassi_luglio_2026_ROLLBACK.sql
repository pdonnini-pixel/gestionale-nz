-- =====================================================================
-- ROLLBACK della 225 — rimozione della ricostruzione di luglio 2026
-- ---------------------------------------------------------------------
...
-- giornate di luglio 2026 create dalla ricostruzione, riconoscibili da
...
--  WHERE c.closing_date BETWEEN '2026-07-01' AND '2026-07-31';
...
-- ATTENZIONE: a differenza di agosto, le righe di daily_revenue di luglio
-- ESISTEVANO GIA' (registro corrispettivi, import storico del 09/09/2026) e
-- la proiezione le ha riscritte con gli stessi identici gross_revenue.
-- NON si cancellano: si riporta solo la provenienza, azzerando i campi che
-- la proiezione ha aggiunto.
