-- ROLLBACK 182 — toglie il trigger e riporta payment_source al comportamento
-- precedente ('manuale' appena closed_manually e' acceso, anche su riga aperta).
BEGIN;

DROP TRIGGER IF EXISTS trg_payable_zz_clear_stale_manual_close ON public.payables;
DROP FUNCTION IF EXISTS public.fn_payable_clear_stale_manual_close();
