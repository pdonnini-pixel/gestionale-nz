-- =====================================================================
-- ROLLBACK della 227 — rimozione della ricostruzione di giugno 2026
-- ---------------------------------------------------------------------
...
-- giornate di giugno 2026 create dalla ricostruzione, riconoscibili da
...
--  WHERE c.closing_date BETWEEN '2026-06-01' AND '2026-06-30';
...
WITH ric AS (
  SELECT id FROM public.outlet_daily_closings
   WHERE closing_date BETWEEN '2026-06-01' AND '2026-06-30'
...
-- Come per luglio, le righe di daily_revenue di giugno ESISTEVANO GIA'
