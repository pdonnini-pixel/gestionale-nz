-- ROLLBACK di 20260909_196 — rimette il confronto senza COALESCE, cioè il comportamento
-- per cui, con payment_method_code NULL, i criteri "categoria a carta" e "fornitore a
-- carta" non venivano valutati. Da usare solo per tornare esattamente allo stato
-- precedente: è il difetto, non una scelta.
