-- =====================================================================
-- ROLLBACK della 231 — rimozione della ricostruzione di gennaio 2026
-- ---------------------------------------------------------------------
-- ATTENZIONE: e' uno script DISTRUTTIVO su dati vivi. Da eseguire SOLO su
-- richiesta esplicita di Patrizio e dopo un SELECT di backup delle 179
-- chiusure (REGOLA GRANITICA NO DATA LOSS). Tocca esclusivamente le
-- giornate di gennaio 2026 create dalla ricostruzione, riconoscibili da
...
--  WHERE c.closing_date BETWEEN '2026-01-01' AND '2026-01-31';
...
WITH ric AS (
  SELECT id FROM public.outlet_daily_closings
   WHERE closing_date BETWEEN '2026-01-01' AND '2026-01-31'
...
-- Come per i mesi precedenti, le righe di daily_revenue di gennaio ESISTEVANO GIA'
