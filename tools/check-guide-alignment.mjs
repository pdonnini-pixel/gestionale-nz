...
const SOURCE_TO_GUIDES = {
  ...
  'src/lib/primaNotaIncassi.ts': ['banche'],
  ...
  'src/pages/ChiusuraCassa.tsx': ['chiusura-cassa'],
  'src/pages/IncassiGiornalieri.tsx': ['incassi-giornalieri'],
  'src/lib/cashClosings.ts': ['chiusura-cassa', 'incassi-giornalieri'],
