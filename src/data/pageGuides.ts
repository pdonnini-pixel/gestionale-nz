  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Dal riquadro \"Quadratura con l'estratto conto\" in Banche → Prima Nota (vista Movimenti banca): per ogni conto il saldo iniziale letto dalla banca più i movimenti del periodo deve dare il saldo finale letto dalla banca. I saldi arrivano dallo scarico A-Cube, non dai nostri movimenti, quindi se dice \"quadra\" non manca niente e non c'è niente di doppio. La stessa tabella è nel foglio Riepilogo dell'Excel. Il contante ha il suo blocco: versamenti e prelievi dal lato banca e, da settembre 2026, incassi, spese, versamenti e fondo cassa dalle chiusure."
      },
      {
