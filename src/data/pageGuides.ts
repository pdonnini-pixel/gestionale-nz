...
export const PAGE_GUIDES: PageGuide[] = [
  ...
  },
  {
    ...
    "faq": [
      ...
      {
        "q": "Perché sul modulo del dipendente le ferie sono in giornate e qui in ore?",
        "a": "Perché sono due letture diverse dello stesso saldo. Il gestionale conta in ore, ed è l'unico modo di farlo tornare quando le persone hanno orari diversi: una giornata non vale otto ore per tutti. Ma chi chiede le ferie ragiona a giornata, mezza giornata, o due ore di permesso, e leggere «8,65 ore» sul proprio foglio non gli dice niente. Quindi il modulo che esce parla la sua lingua e questa pagina, che la usa l'amministrazione, tiene le ore e il dettaglio delle voci."
      },
      {
