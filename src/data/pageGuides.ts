...
export const PAGE_GUIDES: PageGuide[] = [
  ...
  },
  {
    ...
    "icon": "Users",
    "title": "Personale",
    "description": "La pagina Personale raccoglie l'anagrafica dei dipendenti, i cedolini mensili (netto e costo lordo), il confronto con il budget del personale e i ratei di ferie e permessi letti dalle paghe, tutto suddiviso per punto vendita. È il punto dove tenere aggiornati organico, stipendi, allocazioni e residui di ferie.",
    "sections": [
      {
