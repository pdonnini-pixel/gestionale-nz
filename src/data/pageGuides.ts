...
export const PAGE_GUIDES: PageGuide[] = [
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "heading": "Fatture pagate con carta: \"Addebito automatico\"",
        "body": "Le fatture che nel documento riportano come modalità di pagamento la \"carta di pagamento\" (le carte, per esempio quelle BCC) NON sono un pagamento da disporre a mano: vengono addebitate in automatico sul conto tra il 20 e il 30 del mese successivo all'emissione. Per questo il gestionale le riconosce da solo e le mostra con lo stato dedicato \"Addebito automatico\" (badge indaco) invece di \"Scaduto\": non c'è nulla da fare, l'addebito parte da sé. La data mostrata è il 20 del mese successivo (la prima della finestra 20–30), usata come data di addebito prevista. Queste fatture restano comunque conteggiate nel saldo e nel cashflow come uscita futura — non spariscono — finché il movimento bancario reale non arriva e le chiude in automatico con la riconciliazione. Le trovi anche filtrando per stato \"Addebito automatico (carta)\". Se invece un addebito non ti risulta ancora avvenuto oltre la data, il sistema lo tiene comunque come previsto finché la banca non lo riconcilia."
      },
      {
    ...
    "faq": [
      ...
      {
        "q": "Una fattura pagata con carta compare come \"Scaduto\": è un errore?",
        "a": "No, e infatti ora non compare più così. Le fatture con modalità \"carta di pagamento\" (es. carte BCC) sono addebiti automatici: vengono prelevati dal conto tra il 20 e il 30 del mese successivo all'emissione. Il gestionale le riconosce dalla fattura e le segna \"Addebito automatico\" (badge indaco), con data prevista il 20 del mese successivo, invece di \"Scaduto\". Non devi disporre nulla a mano. Restano però contate nel saldo/cashflow come uscita futura finché il movimento bancario reale non le chiude in automatico. Le puoi isolare con il filtro di stato \"Addebito automatico (carta)\"."
      },
      {
