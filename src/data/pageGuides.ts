  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Perché lo studio le assegna in automatico, in ordine cronologico di assunzione, e non può cambiarle. Chi viene riassunto con un nuovo contratto prende una matricola nuova: è successo con un dipendente passato da un rapporto a chiamata a un tempo determinato. Per questo il gestionale non si fida della sola matricola per riconoscere una persona: usa il nome insieme alla matricola o alla data di assunzione, e tiene il registro di tutte le matricole che ha avuto, così anche i dati vecchi restano agganciati."
      },
      {
