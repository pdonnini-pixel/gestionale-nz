  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Quando la banca ti restituisce la distinta delle ricevute bancarie, usa il pulsante \"Carica distinta RiBa\" (in alto tra i filtri, solo per i ruoli contabile e super advisor). Scegli, se vuoi, la banca di addebito e carica il file: va bene un PDF, un CSV o un Excel (.xlsx).\n\nIl sistema legge le righe della distinta (fornitore, numero fattura, importo, scadenza) e le confronta con le scadenze RiBa aperte o già provvisorie: aggancia ogni riga a una scadenza SOLO se l'importo coincide ESATTAMENTE, al centesimo. Niente si chiude a fiducia. Nella schermata di riscontro vedi, per ogni riga: quante sono pronte (importo che quadra con una sola scadenza) e quante sono da verificare (nessuna RiBa dello stesso importo, oppure più scadenze con quell'importo tra cui scegliere a mano dal menu).\n\nCon \"Conferma\" le scadenze agganciate diventano \"Pagato\" definitivo (perdono la dicitura \"provvisorio\") e restano tracciate nel partitario del fornitore. Le righe senza riscontro esatto NON vengono chiuse: restano aperte e le puoi verificare (controlla l'importo) o abbinare più tardi. Se una riga è \"saltata\" perché l'importo non quadra, il gestionale te lo dice nel riepilogo finale."
      },
      {
