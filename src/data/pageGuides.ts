  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Qui abbini i movimenti in uscita dal conto alle fatture fornitori corrispondenti, così il sistema sa quali fatture sono state effettivamente pagate. La scheda si divide in due viste: \"Da riconciliare\" e \"Riconciliati\". Nella vista \"Da riconciliare\", se il sistema trova un possibile abbinamento (per importo, nome fornitore e data) lo propone nella sezione \"Abbinamenti suggeriti\" con una percentuale di affidabilità: puoi confermarlo o rifiutarlo, anche in blocco per più righe insieme. Se selezioni un movimento dall'elenco a sinistra, a destra vedi le fatture proposte come possibile corrispondenza (o puoi cercarne una manualmente). Nella vista \"Riconciliati\" trovi tutti i movimenti già abbinati, con fornitore e numero fattura: da qui puoi annullare un abbinamento sbagliato con \"Annulla abbinamento\" (la fattura torna aperta, il movimento torna da riconciliare). Vengono proposti come abbinamento suggerito solo i casi affidabili: l'importo del movimento deve coincidere con il residuo della fattura (entro il 5%) e l'affidabilità deve essere almeno del 70%; i match con importo lontano non compaiono. Sotto i suggerimenti ad alta affidabilità c'è una seconda sezione \"Da verificare — importo compatibile\": elenca le uscite il cui importo coincide con il residuo di una fattura aperta (entro il 2%) ma su cui il sistema non è del tutto sicuro, tipicamente perché la causale del bonifico non riporta il nome del fornitore (es. \"BEU INTERN BANK …\"). Qui l'abbinamento va confermato una riga alla volta (non c'è \"conferma tutti\"); \"Nascondi\" toglie una proposta che non ti interessa. I movimenti che non sono pagamenti a fornitori (F24, bolli, CBILL/PagoPA, giroconti, commissioni, ricariche) non vengono proposti. Quando invece il numero della fattura è scritto per esteso nella causale del movimento e l'importo coincide, l'abbinamento si chiude già da solo (non serve confermarlo).",
        "steps": [
