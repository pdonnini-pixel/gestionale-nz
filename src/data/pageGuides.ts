    ...
    "sections": [
      {
        ...
        "body": "In alto puoi scegliere l'anno di riferimento: cambia i dati mostrati nei riquadri riepilogativi, nella colonna \"Fatturato\"/\"Da pagare\" della tabella e nella scheda Analytics. I riquadri mostrano: numero totale di fornitori (e quanti attivi), quanti hanno una categoria assegnata, quanti hanno una divisione tra punti vendita configurata, l'importo scaduto e il totale fatturato dell'anno con il numero di fatture.\n\nGli importi \"Da pagare\" e \"Scaduto\" (nei riquadri, nella colonna della tabella, nel dettaglio del fornitore e nell'aging della scheda Analytics) seguono la stessa regola dello Scadenzario, così per uno stesso fornitore le due pagine mostrano lo stesso numero: contano solo le scadenze ancora aperte, al netto delle note di credito ancora da usare; le note di credito già chiuse a mano o registrate nel partitario non vengono più scalate, e la quota di una fattura già messa in distinta e in attesa di riscontro bancario (\"in sospeso\") non viene contata come da pagare. Resta una differenza voluta: qui i totali sono dell'anno scelto (per data fattura), mentre lo Scadenzario mostra tutte le scadenze aperte di qualunque anno.",
        "steps": [
