    ...
    "sections": [
      {
        ...
        "body": "In alto trovi sei schede: Panoramica, Per outlet, Organico, Costi & cedolini, Costo lordo, Ferie e permessi. In alto a destra puoi scegliere l'anno e il mese di riferimento: quasi tutti i numeri della pagina (netti, organico attivo) si riferiscono al mese selezionato. Il pulsante \"Dipendente\" in alto apre subito il modulo per aggiungere una persona nuova."
      },
      {
        "heading": "Panoramica",
      ...
      {
        "heading": "Ferie e permessi — i ratei dalle paghe",
