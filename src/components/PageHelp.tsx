...
const PAGE_HELP: Record<string, string> = {
  ...
  fatturazione: "Tre schede: Passive (fornitori), Attive (vendite), Corrispettivi. Le fatture passive e attive arrivano da sole dal Cassetto Fiscale via A-Cube, ogni 6h (o subito con 'Sincronizza SDI'). Nel tab Attive cerchi per cliente/numero e filtri per mese. Per produrre gli XML da caricare in Agenzia delle Entrate usa 'Converti Excel → XML' (con archivio delle generazioni). 'Nuova via A-Cube' è temporaneamente disattivato. Guida completa nel pulsante ? in basso a destra.",
