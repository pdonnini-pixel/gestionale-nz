...
export function buildGuidaRows(g: GuidaInput): StyledRow[] {
  const rows: StyledRow[] = [
    ...
    t('N. fatture e Causale', 'Quante fatture salda il movimento e i loro numeri. Per gli F24: titolo, codice tributo e periodo. Altrimenti la causale della banca. Le RiBa: «RiBa · Fatt. …».'),
