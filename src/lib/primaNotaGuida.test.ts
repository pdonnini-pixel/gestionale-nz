...
describe('buildGuidaRows: il foglio Guida spiega ogni foglio e come si cerca', () => {
  const rows = buildGuidaRows({ periodo: 'Settembre 2026', dataUsata: 'data contabile (banca)', conti: ['BCC Valdarno', 'MPS'], carte: ['Carta credito BCC 5388'], flussiSenzaBuste: 1 })
  ...
  it('senza carte e senza flussi orfani lo dice, e le sezioni hanno il tipo giusto', () => {
    const r2 = buildGuidaRows({ periodo: 'x', dataUsata: 'y', conti: [], carte: [], flussiSenzaBuste: 0 })
