                        ...
                        {isConfirm ? (
                          ...
                          <>
                            ...
                            <div className="text-[11px] text-slate-500">
                              {r.ivaCreditoStimato
                                ? (r.stato === 'in_corso'
                                  ? `${r.nFatturePassive} fatture ricevute: ${fmt(r.ivaCreditoRicevuto)} · proiezione a fine mese`
